...
export type AuthLoginMutation = {
  ...
  authLogin?: {
    ...
    error?: { __typename?: "ErrorType"; message: string; code: string } | null;
  } | null;
};
...
export type RegisterUserMutation = {
  ...
  registerUser?: {
    ...
    error?: { __typename?: "ErrorType"; code: string; message: string } | null;
  } | null;
};
 ...
 * });
 */
export function useGetAdminAccountQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAdminAccountQuery,
    GetAdminAccountQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAdminAccountQuery, GetAdminAccountQueryVariables>(
    GetAdminAccountDocument,
    options
  );
}
export function useGetAdminAccountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAdminAccountQuery,
    GetAdminAccountQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetAdminAccountQuery,
    GetAdminAccountQueryVariables
  >(GetAdminAccountDocument, options);
}
export type GetAdminAccountQueryHookResult = ReturnType<
  typeof useGetAdminAccountQuery
>;
export type GetAdminAccountLazyQueryHookResult = ReturnType<
  typeof useGetAdminAccountLazyQuery
>;
export type GetAdminAccountQueryResult = Apollo.QueryResult<
  GetAdminAccountQuery,
  GetAdminAccountQueryVariables
>;
